    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mail', models.EmailField(max_length=254, null=True, validators=[students.validators.validate_unique_email, students.validators.ValidEmailDomain('@gmail.com', '@yahoo.com', '@test.com')])),
            ],
            options={
                'db_table': 'students',
            },
